...
// Allowed MIME types and extensions for team member images
...
export async function POST(request) {
  ...
  try {
    ...
    const relativeUrl = `/uploads/teams/${uniqueFilename}`;
    ...
    console.error("POST Admin Team Image Upload API Error:", error);
    return NextResponse.json(
