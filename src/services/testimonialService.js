...
const SEED_TESTIMONIALS = [
  {
    ...
    text: "Gupta Tech Web transformed our online store. The new architecture is blazingly fast, and we saw a 40% increase in conversions within the first month. Highly recommended team!",
    rating: 5,
    status: "published",
  },
  {
    ...
    text: "Our supply chain operations were completely modernized. Gupta Tech Web engineered a custom dashboard that gives us real-time insights, saving us countless hours of manual work.",
    rating: 5,
    status: "published",
  },
  {
    ...
    name: "Sarah Collins",
    project: "Healthcare CRM App",
    text: "They delivered our mobile application ahead of schedule. The team was incredibly responsive, and their attention to UI/UX details made the app extremely intuitive for our medical staff.",
    rating: 5,
    status: "published",
  },
  {
    img: "/assets/images/hero/client-img1.png",
    name: "Emma Robertson",
    project: "SEO & Digital Strategy",
    text: "Their digital marketing expertise is unmatched. Our organic traffic doubled in just 6 months, and the quality of leads has improved significantly. A fantastic partner for growth.",
    rating: 5,
    status: "published",
  },
  {
    ...
    text: "Security and compliance were our top priorities, and Gupta Tech Web delivered perfectly. Their backend engineering is world-class, ensuring our transactions are safe and lightning fast.",
    rating: 5,
    status: "published",
  },
  {
    img: "/assets/images/hero/client-img3.png",
    name: "Linda Martinez",
    project: "Brand Identity & UX",
    text: "The UI/UX team completely overhauled our legacy application. The fresh, modern interface has dramatically increased our user retention and simplified the onboarding process.",
    rating: 5,
    status: "published",
  },
];
